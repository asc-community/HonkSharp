...
M00_L00:
       mov       rcx,[rbp+0FFF0]
       mov       r11,7FF9B11903B0
       call      qword ptr [7FF9B14F03B0]
;                 a += i;
;                 ^^^^^^^
       add       esi,eax
       mov       rcx,[rbp+0FFF0]
...
M00_L01:
       mov       rcx,[rbp+0FFF0]
       mov       r11,7FF9B11903B8
       call      qword ptr [7FF9B14F03B8]
;             return a;
;             ^^^^^^^^^
       mov       eax,esi
       lea       rsp,[rbp+0FFF8]
...
;             ^^^^^^^^^^
       ...
       call      System.Linq.Enumerable.Range(Int32, Int32)
       mov       rcx,rax
       mov       r11,7FF9B1180390
       call      qword ptr [7FF9B14E0390]
       mov       rcx,rax
       mov       [rbp+0FFF0],rcx
;             foreach (var i in Enumerable.Range(0, n))
;                            ^^
       mov       r11,7FF9B1180398
       call      qword ptr [7FF9B14E0398]
       test      eax,eax
       je        short M00_L01
M00_L00:
       mov       rcx,[rbp+0FFF0]
