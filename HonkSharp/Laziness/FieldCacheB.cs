...
namespace HonkSharp.Laziness
{
    ...
    /// </typeparam>
    public struct FieldCacheB<TThis, T> : IEquatable<FieldCacheB<TThis, T>> where TThis : class
    {
        private T? value;
        ...
        /// without limitations.
        /// </param>
        public FieldCacheB(Func<TThis, T> factory)
        {
            holder = null;
            value = default;
        ...
        /// </summary>
        public bool Equals(FieldCacheB<TThis, T> _)
            => true;
